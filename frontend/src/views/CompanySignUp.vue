  ...
  <v-card class="container mb-5">
    ...
    <v-row class="d-flex justify-content-center">
      <v-col cols="3" class="company-logo-form">
        ...
        <div class="filebox company-logo-button">
          ...
          <input type="file" id="company_logo" @change="changeImage" ref="img" accept="img/*" multiple >
        </div>
      </v-col>
      <v-col cols="6">
    ...
    <v-container>
      <v-row class="d-flex justify-content-center mt-5">
        <v-col cols="4">
          <v-btn block text x-large class="primary-color text-white rounded-0" @click="companySignup">
            회원가입
          </v-btn>
        </v-col>
        <v-col cols="4">
          <v-btn block text x-large class="secondary-color text-white rounded-0" @click="closeCompanySignUp">
            취소
          </v-btn>
        </v-col>
      </v-row>
  ...
  data () {
    return {
      ...
      passwordConfirmRules: [
        v => !!v || '필수 항목 입니다',
        v => v === this.companySignupForm.companyPassword || '입력한 비밀번호와 일치하지 않습니다',
      ],
      emailRules: [
        v => !!v || '필수 항목 입니다',
